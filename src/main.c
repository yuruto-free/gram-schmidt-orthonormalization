...
double vec1[9] = {
    1.0, 1.0, 0.0, 1.0, 0.0, 2.0, 2.0, 1.0, 3.0,
};
double vec2[12] = {
    1.0, 1.0, -2.0, 2.0, 0.0, 1.0, -1.0, 0.0, 3.0, 5.0, -2.0, 1.0,
};
double vec3[20] = {
    1.0, 2.0,  1.0, 3.0,  -1.0, 0.0, -2.0, -3.0, 3.0, -2.0,
    2.0, -3.0, 0.0, -4.0, 3.0,  3.0, 1.0,  2.0,  3.0, -4.0,
};
const double ans1[9] = {
    sqrt(2) / 2,     sqrt(2) / 2, 0.0,       sqrt(2) / 6, -sqrt(2) / 6,
    2 * sqrt(2) / 3, -2.0 / 3.0,  2.0 / 3.0, 1.0 / 3.0,
};
const double ans2[12] = {
    sqrt(10) / 10,       sqrt(10) / 10,        -sqrt(10) / 5,
    sqrt(10) / 5,        -3 * sqrt(110) / 110, 7 * sqrt(110) / 110,
    -2 * sqrt(110) / 55, -3 * sqrt(110) / 55,  26 * sqrt(165) / 495,
    4 * sqrt(165) / 99,  4 * sqrt(165) / 99,   -sqrt(165) / 165,
};
const double ans3[20] = {
    ...
    45 * sqrt(5334) / 53340,
    87 * sqrt(5334) / 17780,
    334 * sqrt(347494098) / 24821007,
    -626 * sqrt(347494098) / 57915683,
    913 * sqrt(347494098) / 49642014,
    -6257 * sqrt(347494098) / 347494098,
    -2536 * sqrt(347494098) / 57915683,
};
